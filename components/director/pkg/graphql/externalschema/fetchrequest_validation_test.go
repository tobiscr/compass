...
func TestFetchRequestInput_Validate_Mode(t *testing.T) {
	testCases := []struct {
		Name          string
		Value         *externalschema.FetchMode
		ExpectedValid bool
	}{
		{
			Name:          "ExpectedValid",
			Value:         (*externalschema.FetchMode)(str.Ptr("SINGLE")),
			ExpectedValid: true,
		},
		{
			Name:          "ExpectedValid nil value",
		...
		{
			Name:          "Invalid object",
			Value:         (*externalschema.FetchMode)(str.Ptr("INVALID")),
			ExpectedValid: false,
		},
	}
...
func fixValidFetchRequestInput() externalschema.FetchRequestInput {
