...
func TestAuthInput_Validate_Credential(t *testing.T) {
	...
	testCases := []struct {
		Name          string
		Value         *externalschema.CredentialDataInput
		ExpectedValid bool
	}{
		{
			Name:          "ExpectedValid",
...
func TestAuthInput_Validate_AdditionalHeaders(t *testing.T) {
	testCases := []struct {
		Name          string
		Value         *externalschema.HttpHeaders
		ExpectedValid bool
	}{
		{
			Name: "ExpectedValid",
...
func TestAuthInput_Validate_AdditionalQueryParams(t *testing.T) {
	testCases := []struct {
		Name          string
		Value         *externalschema.QueryParams
		ExpectedValid bool
	}{
		{
			Name: "ExpectedValid",
...
func TestAuthInput_Validate_RequestAuth(t *testing.T) {
	...
	testCases := []struct {
		Name          string
		Value         *externalschema.CredentialRequestAuthInput
		ExpectedValid bool
	}{
		{
			Name:          "ExpectedValid",
...
func fixValidAuthInput() externalschema.AuthInput {
	credential := fixValidCredentialDataInput()
...
func fixValidCredentialDataInput() externalschema.CredentialDataInput {
	basic := fixValidBasicCredentialDataInput()
	return externalschema.CredentialDataInput{
		Basic: &basic,
		Oauth: nil,
	}
}

func fixValidBasicCredentialDataInput() externalschema.BasicCredentialDataInput {
	return externalschema.BasicCredentialDataInput{
		Username: "John",
		Password: "P3!@2sklasdjkfla",
	}
}

func fixValidOAuthCredentialDataInput() externalschema.OAuthCredentialDataInput {
	return externalschema.OAuthCredentialDataInput{
		ClientID:     "client",
		ClientSecret: "secret",
		URL:          "http://valid.url",
	}
...
func fixValidCredentialRequestAuthInput() externalschema.CredentialRequestAuthInput {
	csrf := fixValidCSRFTokenCredentialRequestAuthInput()
	return externalschema.CredentialRequestAuthInput{
		Csrf: &csrf,
	}
}

func fixValidCSRFTokenCredentialRequestAuthInput() externalschema.CSRFTokenCredentialRequestAuthInput {
	credential := fixValidCredentialDataInput()
	return externalschema.CSRFTokenCredentialRequestAuthInput{
