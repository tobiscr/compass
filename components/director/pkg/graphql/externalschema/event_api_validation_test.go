...
func TestEventAPIDefinitionInput_Validate_Spec(t *testing.T) {
	...
	emptyObj := externalschema.EventSpecInput{}

	testCases := []struct {
		Name          string
		Value         *externalschema.EventSpecInput
		ExpectedValid bool
	}{
		{
...
func TestEventAPISpecInput_Validate_EventSpecType(t *testing.T) {
	testCases := []struct {
		Name          string
		Value         externalschema.EventSpecType
		ExpectedValid bool
	}{
		{
			Name:          "ExpectedValid",
			Value:         externalschema.EventSpecTypeAsyncAPI,
			ExpectedValid: true,
		},
		{
			Name:          "Invalid object",
			Value:         externalschema.EventSpecType("INVALID"),
			ExpectedValid: false,
		},
		{
...
func TestEventAPISpecInput_Validate_Format(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			Value:         externalschema.SpecFormatYaml,
			ExpectedValid: true,
		},
		{
			Name:          "Invalid object",
...
func fixValidEventAPISpecInput() externalschema.EventSpecInput {
	req := fixValidFetchRequestInput()
	return externalschema.EventSpecInput{
		FetchRequest: &req,
...
func fixValidEventAPIDefinitionInput() externalschema.EventDefinitionInput {
	eventSpec := fixValidEventAPISpecInput()
	return externalschema.EventDefinitionInput{Name: "valid-name", Spec: &eventSpec}
}
