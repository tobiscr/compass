...
func TestResolver_CreateRuntime(t *testing.T) {
	...
	desc := "Lorem ipsum"
	gqlInput := externalschema.RuntimeInput{
		Name:        "Foo",
		Description: &desc,
	}
	...
	testCases := []struct {
		...
		ExpectedRuntime *externalschema.Runtime
		ExpectedErr     error
	}{
		{
			Name: "Success",
...
func TestResolver_Runtimes(t *testing.T) {
	...
	gqlRuntimes := []*externalschema.Runtime{
	...
	testCases := []struct {
		...
		ExpectedResult    *externalschema.RuntimePage
		ExpectedErr       error
	}{
		{
			Name: "Success",
...
func TestResolver_Labels(t *testing.T) {
	...
	testCases := []struct {
		...
		TransactionerFn func(persistTx *persistenceautomock.PersistenceTx) *persistenceautomock.Transactioner
		ServiceFn       func() *automock.RuntimeService
		InputRuntime    *externalschema.Runtime
		InputKey        string
...
func TestResolver_EventingConfiguration(t *testing.T) {
	...
	testCases := []struct {
		...
		ExpectedOutput  *externalschema.RuntimeEventingConfiguration
		ExpectedError   error
	}{
		{
			Name:            "Success",
	...
	t.Run("Error when parent object ID is not a valid UUID", func(t *testing.T) {
		...
		// WHEN
		result, err := resolver.EventingConfiguration(ctx, &externalschema.Runtime{ID: "abc"})
