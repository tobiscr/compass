...
func TestResolver_Apis(t *testing.T) {
	...
	gqlAPIDefinitions := []*externalschema.APIDefinition{
	...
	testCases := []struct {
		...
		ServiceFn       func() *automock.APIService
		ConverterFn     func() *automock.APIConverter
		ExpectedResult  *externalschema.APIDefinitionPage
		ExpectedErr     error
	}{
		{
			Name:            "Success",
...
func TestResolver_EventAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		InputID         string
		Package         *externalschema.Package
		ExpectedAPI     *externalschema.EventDefinition
		ExpectedErr     error
	}{
		{
			Name:            "Success",
...
func TestResolver_EventAPIs(t *testing.T) {
	...
	gqlEventAPIDefinitions := []*externalschema.EventDefinition{
	...
	testCases := []struct {
		...
		ExpectedResult  *externalschema.EventDefinitionPage
		ExpectedErr     error
	}{
		{
			Name:            "Success",
...
func TestResolver_Document(t *testing.T) {
	...
	testCases := []struct {
		...
		InputID         string
		Package         *externalschema.Package
		ExpectedDoc     *externalschema.Document
		ExpectedErr     error
	}{
		{
			Name:            "Success",
...
func TestResolver_Documents(t *testing.T) {
	...
	gqlDocuments := []*externalschema.Document{
		fixGQLDocument("foo"),
		fixGQLDocument("bar"),
	}
	...
	testCases := []struct {
		...
		ExpectedResult  *externalschema.DocumentPage
		ExpectedErr     error
	}{
		{
			Name:            "Success",
...
func TestResolver_UpdateAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		ServiceFn       func() *automock.PackageService
		ConverterFn     func() *automock.PackageConverter
		InputPackage    externalschema.PackageUpdateInput
		ExpectedPackage *externalschema.Package
		ExpectedErr     error
	}{
		{
...
func TestResolver_InstanceAuth(t *testing.T) {
	...
	testCases := []struct {
		...
		InputID                     string
		Package                     *externalschema.Package
		ExpectedPackageInstanceAuth *externalschema.PackageInstanceAuth
		ExpectedErr                 error
	}{
		{
			Name:            "Success",
...
func TestResolver_InstanceAuths(t *testing.T) {
	...
	gqlPackageInstanceAuths := []*externalschema.PackageInstanceAuth{
